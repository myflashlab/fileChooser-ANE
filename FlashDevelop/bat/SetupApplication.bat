...
:: Android packaging
set AND_CERT_NAME="exFileBrowser"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\exFileBrowser.p12
...
set IOS_PROVISION_DEV=cert\exFileBrowser.mobileprovision
...
set APP_ID=com.doitflash.exFileBrowser

:: Output packages
set DIST_PATH=dist
set DIST_NAME=exFileBrowser
